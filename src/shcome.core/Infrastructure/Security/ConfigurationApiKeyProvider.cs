...
namespace shcome.core.Infrastructure.Security
{
    /// <summary>
    ...
    {
        private readonly ShcomeSettings _settings;
        ...
        public ConfigurationApiKeyProvider(IOptions<ShcomeSettings> settings, ILogger<ConfigurationApiKeyProvider> logger)
        {
            logger.CheckArgumentNull(nameof(logger));

            _settings = settings?.Value ?? new ShcomeSettings();
        }
        /// <inheritdoc/>>
